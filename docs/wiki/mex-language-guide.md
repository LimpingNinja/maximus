...
You've built things in the [lessons]({% link mex-learning.md %}). You've wired
...
[Standard Intrinsics]({% link mex-standard-intrinsics.md %})). Think of this
...
|-------|------|-----------------|
| [Variables & Types](#vars) | [Variables & Types]({% link mex-language-vars-types.md %}) | Primitive types, arrays, structs, type conversions, the `usr` record |
| [Control Flow](#flow) | [Control Flow]({% link mex-language-control-flow.md %}) | `if`/`else`, `while`, `do`/`while`, `for`, `goto`, `break` |
| [Functions & Scope](#funcs) | [Functions & Scope]({% link mex-language-functions-scope.md %}) | Declaring functions, parameters, `ref` pass-by-reference, scope rules |
| [String Operations](#strings) | [String Operations]({% link mex-language-string-ops.md %}) | Concatenation, slicing, searching, conversion, and every string function |
...
[Variables & Types]({% link mex-language-vars-types.md %}).
...
[Control Flow]({% link mex-language-control-flow.md %}).
...
See [Functions & Scope]({% link mex-language-functions-scope.md %}).
...
- [Standard Intrinsics]({% link mex-standard-intrinsics.md %}) — the built-in
