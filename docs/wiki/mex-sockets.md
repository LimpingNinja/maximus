...
section: "mex"
title: "MEX Sockets"
description: "HTTP/HTTPS networking from MEX scripts"
---
...
TLS is handled automatically under the hood via mbedTLS. Your callers won't
notice any difference except that the request is encrypted in transit.
