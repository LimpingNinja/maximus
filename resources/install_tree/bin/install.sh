...
main() {
    ...
    echo ""
    echo -e "${CYAN}Configuration files are in:${NC} ${WHITE}config/${NC} (TOML)"
    echo -e "${CYAN}After editing language/display/MEX files, run:${NC} ${WHITE}bin/recompile.sh${NC}"
    echo ""
    echo -e "${LBLUE}═══════════════════════════════════════════════════════════════${NC}"
