...
%       MenuColour      15
  ...
  NoDsp Press_Enter                             Demoted "S"
        ...
        Display_File    etc/misc/yellreq            Demoted "Yell for SysOp"
  NoDsp Yell                                    Demoted "Y"
        ...
        Display_File    etc/misc/bulletin           Demoted "Bulletins"
...
%       MenuFile        Misc\MenuMsg
  ...
  Local Display_File    etc/help/msg                 Demoted "?help"
 Matrix Display_File    etc/help/mail                Demoted "?help"
   Echo Display_File    etc/help/echo                Demoted "?help"
        %
End Menu
...
%       MenuFile        Misc\MenuFile
  ...
  NoDsp Press_Enter                             Demoted "S"
        ...
        Goodbye                               Transient "Goodbye (log off)"
        Display_File   etc/help/filehelp            Demoted "?help"
        %
End Menu
...
%       MenuFile        Misc\MenuChg
  ...
  NoDsp Display_Menu    MAIN                  Transient "|"
        Display_File    etc/help/change              Demoted "?help"
        %
End Menu
...
%       MenuFile        Misc\MenuEdit
        ...
        Display_File    etc/help/editor       Transient "?help"
        %
End Menu
...
%       MenuFile        Misc\MenuChat
        ...
        Display_File    etc/misc/chathelp       Demoted "?help"
End Menu


Menu READER
        Title           READER (%t mins)
        HeaderFile      etc/misc/olr_hdr
        ...
        Display_Menu    MAIN                  Transient "Main menu"
        Goodbye                               Transient "Goodbye (log off)"
        Display_File    etc/help/olr                 Demoted "?help"
  NoDsp Display_Menu    MAIN                  Transient "|"
End Menu
...
#UsrRemote Xtern_Run     Command.Com_>com%P_<com%P   Sysop "OS shell"
UsrLocal  Xtern_Run     /bin/sh                 Sysop "OS shell"
