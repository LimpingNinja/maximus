% Updated by INSTALL v3.00 on 05-12-03.
%
%
%
%
...
%       Video BIOS
        ...
        Path Language   /var/max/etc/lang
...
Include /var/max/etc/access.ctl
...
%       Nodelist        Version FD
        ...
        Path NetInfo    /var/max/etc/nodelist
...
%       Logon           Preregistered
        ...
        Uses BadLogon   etc/misc/badlogon
...
***************************** General Filenames *****************************
        ...
        Uses Application etc/misc/applic
        ...
        Uses NewUser1   etc/misc/newuser1
...
%       Uses Configure  Misc\Configure
        ...
        Uses NewUser2   etc/misc/newuser2
...
%       Uses Rookie     Misc\Rookie
        ...
        Uses DayLimit   etc/misc/daylimit
...
%       Uses FileAreas          Misc\Filearea
        ...
        Uses Filename_Format    etc/misc/fformat
...
%       Uses MsgAreas           Misc\Msgarea
        ...
        Uses HeaderHelp         etc/misc/hdrentry
        ...
        Uses EntryHelp          etc/misc/msgentry
...
%        Save Directories        CDEFGHIJKLMNOPQRSTUVWXYZ
       ...
       Save Directories
        ...
        Uses Shell_Leaving      etc/misc/shellbye
        Uses Shell_Returning    etc/misc/shellhi
...
%        StatusLine
        ...
        Uses Barricade          etc/misc/barricad
...
Include etc/colors.ctl
Include etc/reader.ctl
Include etc/language.ctl
Include etc/msgarea.ctl
Include etc/filearea.ctl
Include etc/menus.ctl
Include etc/protocol.ctl
