...
extern int ngcfg_get_int(const char *toml_path) __attribute__((weak));
#else
extern int ngcfg_get_int(const char *toml_path);
#endif

#define carrier_flag          ((word)(ngcfg_get_int ? ngcfg_get_int("general.equipment.carrier_mask") : 0))
