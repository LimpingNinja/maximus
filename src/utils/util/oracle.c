...
static char rcs_id[]="$Id: oracle.c,v 1.4 2004/01/27 23:02:55 paltas Exp $";
...
static void Oracle_Help(void)
{
  ...
  printf("environment variable.  (Note that environment variable settings can be overriden on\n");
...
int File_Get_Download_Names(int do_tag, sword protocol) {NW(do_tag); NW(protocol); return 0;}
