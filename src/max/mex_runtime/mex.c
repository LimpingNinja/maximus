...
static struct _usrfunc _intrinfunc[]=
{
  ...
  {"lang_load_extension",     intrin_lang_load_extension,     0},
  {"lang_register",           intrin_lang_register,           0},
  {"lang_unregister",         intrin_lang_unregister,         0},
  ...
  {"ui_make_attr",            intrin_ui_make_attr,            0},
  {"ui_mci2attr",             intrin_mci2attr,                0},
  {"ui_set_attr",             intrin_ui_set_attr,             0},
  {"ui_fill_rect",            intrin_ui_fill_rect,            0},
  {"ui_write_padded",         intrin_ui_write_padded,         0},
  {"ui_prompt_field",         intrin_ui_prompt_field,         0},
  ...
  {"ui_lightbar_style_default", intrin_ui_lightbar_style_default, 0},
  {"ui_select_prompt",        intrin_ui_select_prompt,        0},
  {"ui_select_prompt_hotkey", intrin_ui_select_prompt_hotkey, 0},
...
void EXPENTRY intrin_term(short *psRet)
{
  ...
  if (pmis->set_current != pmis->pmm->current)
  {
    ...
    if (sq && ngcfg_get_bool("general.session.use_umsgids"))
