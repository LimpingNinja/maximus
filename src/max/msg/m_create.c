...
static char rcs_id[]="$Id: m_create.c,v 1.3 2004/01/27 21:00:30 paltas Exp $";
...
int Goodbye_Comment(void)
{
  ...
  where=*ngcfg_get_string_raw("general.session.comment_area") ?
        (char *)ngcfg_get_string_raw("general.session.comment_area") : zero;
