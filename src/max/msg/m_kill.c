...
static char rcs_id[]="$Id: m_kill.c,v 1.4 2004/01/28 06:38:10 paltas Exp $";
...
{
  return (ToOrFromUs(msg) || GEPriv(usr.priv, ngcfg_get_int("matrix.private_priv")) || mailflag(CFLAGM_PVT));
}
