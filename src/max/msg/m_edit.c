...
{
  debug_log("Free_Line: linenum=%d num_lines(before)=%d ptr=%p", linenum, (int)num_lines, (void *)screen[linenum]);
  ...
  debug_log("Free_Line: linenum=%d num_lines(after)=%d", linenum, (int)num_lines);
}
...
void Free_All(void)
{
  ...
  debug_log("Free_All: START num_lines=%d screen_base=%p num_lines_addr=%p", (int)num_lines, (void *)&screen[0], (void *)&num_lines);
  ...
  debug_log("Free_All: END num_lines=%d", (int)num_lines);
}
