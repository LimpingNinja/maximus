...
static char rcs_id[]="$Id: emsi.c,v 1.3 2004/01/27 21:00:27 paltas Exp $";
...
static void near EmsiBldISI(void)
{
  ...
  EmsiBldA1(percent_s, ngcfg_get_string_raw("maximus.system_name"));          /* {FWP} */
  EmsiBldA1(percent_s, location);                  /* {Kingston, Ontario} */
  EmsiBldA1(percent_s, ngcfg_get_string_raw("maximus.sysop"));                /* {Scott Dudley} */
